...
public class NativeShapeBuffer {
  ...
  public void put(float[] vertexData, int offsetInFloats){
    vertexBuffer.putAll(vertexData, offsetInFloats);
  ...
  public void checkedPut(float[] vertexData, int offsetInFloats){
    validateFloatAlignment(offsetInFloats);
    validateFloatAlignment(vertexData.length);
    put(vertexData, offsetInFloats);
  }
  
  public void checkedPutShapes(float[] vertexData, int offsetInShapes){
    validateFloatAlignment(vertexData.length);
    put(vertexData, offsetInShapes* vertexSizeFloats * vertsPerShape);
  }
