...
public class UndirectedGeometricGraph extends Demo {
  
  private IntParam numNodes;
  private FloatParam nodeSize;
  private FloatParam minDistForEdge;

  public UndirectedGeometricGraph() {
    super("Undirected Geometric Graph");
  ...
  protected void setup(Engine engine) {
    ...
    UndirectedGraph<Node,Edge> graph = Geometric.generateUndirectedGeometricGraph(nodes, minDistForEdge.getValue(), math);
    GraphView view = GraphViews.simpleView(graph, engine, BufferUsage.STATIC);
